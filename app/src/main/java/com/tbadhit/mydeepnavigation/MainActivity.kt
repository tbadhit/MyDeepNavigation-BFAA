...
import com.tbadhit.mydeepnavigation.databinding.ActivityMainBinding

// Task and backstack

// Codelab :
// Update "activity_main.xml"
// create new activity "DetailActivity"
// Update "activity_detail.xml"
// Add code "DetailActivity" (1)
// add code android:launchMode="singleTop" to .MainActivity "AndroidManifest"
// add code android:parentActivityName=".MainActivity" to .DetailActivity "AndroidManifest"
/*
   add :
   <meta-data
    android:name="android.support.PARENT_ACTIVITY"
    android:value=".MainActivity" />
    to .DetailActivity "AndroidManifest"
 */
// add code "MainActivity" (1) all 1
